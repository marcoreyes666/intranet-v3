                ...
                <form method="POST" action="{{ route('admin.departments.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input name="slug" value="{{ old('slug') }}" placeholder="Se autogenera si lo dejas vacío"
                                   class="w-full border-gray-300 dark:border-gray-700 rounded">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full border-gray-300 dark:border-gray-700 rounded">{{ old('description') }}</textarea>
                    ...
                    <div class="pt-2 flex gap-2">
                        <button class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Guardar</button>
